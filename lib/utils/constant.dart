//With PHP backend
 const BASE_URL = "https://test-app2.mangopos.xyz";
...
//AdmobId
const adMobBannerId = 'ADD YOUR ADMOB KEY';
const adMobInterstitialId = 'ADD YOUR ADMOB KEY';
const adMobBannerIdIos = 'ADD YOUR ADMOB KEY';
const adMobInterstitialIdIos = 'ADD YOUR ADMOB KEY';

// Facebook
const FACEBOOK_KEY = 'b9f2908b-1a6b-4a5b-b862-ded7ce289e41';
const fbBannerId = "ADD YOUR FACEBOOK BANNER ID";
const fbBannerIdIos = "ADD YOUR FACEBOOK BANNER ID IOS";
const fbInterstitialId = "ADD YOUR FACEBOOK Interstitial ID";
const fbInterstitialIdIos = "ADD YOUR FACEBOOK Interstitial ID IOS";
