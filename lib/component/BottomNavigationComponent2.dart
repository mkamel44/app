...
import 'package:mightyweb/utils/BubbleBotoomBar.dart';
  ...
  Widget build(BuildContext context) {
    return mBottomMenuList!=null?BubbleBottomBar(
      ...
      items: <BubbleBottomBarItem>[
        ...
        for (int i = 0; i < appStore.mBottomNavigationList.length; i++) tab(mBottomMenuList![i].image.validate(), mBottomMenuList![i].title.toString(), context)
      ],
    ):SizedBox();
  }
}
