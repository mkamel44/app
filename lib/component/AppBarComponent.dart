...
import 'package:mightyweb/component/TabBarComponent.dart';
...
class AppBarComponentState extends State<AppBarComponent> {
  ...
  Widget mAppBarLeft() {
    if (getStringAsync(NAVIGATIONSTYLE) == NAVIGATION_STYLE_SIDE_DRAWER || getStringAsync(NAVIGATIONSTYLE) == NAVIGATION_STYLE_BOTTOM_NAVIGATION_SIDE_DRAWER) {
      return IconButton(
